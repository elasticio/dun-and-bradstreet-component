...
public class WSPolicyUtil {
   ...
   * wsu:Id="UsernameToken-2"> <wsse:Username>login</wsse:Username> <wsse:Password
   * Type="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText">password</wsse:Password>
   * </wsse:UsernameToken> </wsse:Security> </SOAP-ENV:Header>
   */
  public static SOAPHeader addWSSEHeader(final SOAPMessage soapMessage, final String login,
    ...
    try {
      ...
      logger.error("Oops! Error trying to  add a WS policy");
    }
    return header;
  }
}
