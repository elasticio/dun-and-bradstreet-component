...
public class SmallBusinessRiskInsight implements Module {
    ...
    public void execute(ExecutionParameters parameters) {
        ...
        try {
            ...
            SOAPMessage response = new GenericSOAPClient.Builder()
                    ...
                    .setEndpointUrl(EndpointUrl.SMALL_BUSINESS_RISK_INSIGHT)
                    .setSoapAction(SoapAction.SMALL_BUSINESS_RISK_INSIGHT)
