 ...
 *       &lt;sequence>
 *         &lt;element name="CompensationTypeText" type="{http://services.dnb.com/ContactProductServiceV2.0}DNBDecodedStringType"/>
 *         &lt;element name="CompensationAmount" type="{http://services.dnb.com/ContactProductServiceV2.0}AmountType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CompensationDetail", namespace = "http://services.dnb.com/ContactProductServiceV2.0", propOrder = {
    "compensationTypeText",
    "compensationAmount"
})
public class CompensationDetail {

    @XmlElement(name = "CompensationTypeText", required = true)
