 ...
 *         &lt;element name="MinimumPaymentAmount" type="{http://services.dnb.com/CustomProductServiceV2.0}AmountType" minOccurs="0"/>
 *         &lt;element name="CurrentBalanceAmount" type="{http://services.dnb.com/CustomProductServiceV2.0}AmountType" minOccurs="0"/>
 *         &lt;element name="CurrentDueAmount" type="{http://services.dnb.com/CustomProductServiceV2.0}AmountType" minOccurs="0"/>
 *         &lt;element name="TotalPastDueAmount" type="{http://services.dnb.com/CustomProductServiceV2.0}AmountType" minOccurs="0"/>
 *         &lt;element name="PastDueCycleSummary" type="{http://services.dnb.com/CustomProductServiceV2.0}PastDueCycleSummary" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "CurrentPayment", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
    "lenderName",
    "lenderID",
    "paymentReportedDate",
