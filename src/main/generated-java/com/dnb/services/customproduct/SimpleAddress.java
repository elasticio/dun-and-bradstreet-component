...
@XmlType(name = "SimpleAddress", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
    "streetAddressLine",
    "primaryTownName",
    "countryISOAlpha2Code"
})
@XmlSeeAlso({
    LocationDetailForAlert.class,
    PrincipalBirthAddressType.class,
