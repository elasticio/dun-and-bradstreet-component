 ...
 *         &lt;element name="PoliticalDistrict" type="{http://services.dnb.com/CustomProductServiceV2.0}PoliticalDistrict" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ResidentialAddressIndicator" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="OfficeOrWorkAddressIndicator" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
@XmlType(name = "PrimaryAddressType", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
    "registeredAddressIndicator",
    "politicalDistrict",
    "residentialAddressIndicator",
    "officeOrWorkAddressIndicator",
    ...
    extends BaseAddressType
{
    ...
    @XmlElement(name = "OfficeOrWorkAddressIndicator")
    protected Boolean officeOrWorkAddressIndicator;
    ...
    /**
     * Gets the value of the officeOrWorkAddressIndicator property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isOfficeOrWorkAddressIndicator() {
        return officeOrWorkAddressIndicator;
    }

    /**
     * Sets the value of the officeOrWorkAddressIndicator property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setOfficeOrWorkAddressIndicator(Boolean value) {
        this.officeOrWorkAddressIndicator = value;
    }
