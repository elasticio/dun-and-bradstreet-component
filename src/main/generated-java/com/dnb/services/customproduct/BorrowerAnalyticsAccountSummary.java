 ...
 *         &lt;element name="BorrowingAccountTypeText" type="{http://services.dnb.com/CustomProductServiceV2.0}DNBDecodedStringType" minOccurs="0"/>
 *         &lt;element name="AccountsTotalExposureAmount" type="{http://services.dnb.com/CustomProductServiceV2.0}AmountType" minOccurs="0"/>
 *         &lt;element name="AmountOutstandingPercentage" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="OpenAccountsCurrentBalanceAmount" type="{http://services.dnb.com/CustomProductServiceV2.0}AmountType" minOccurs="0"/>
 ...
 *         &lt;element name="BorrowerAnalyticsCycleSummary" type="{http://services.dnb.com/CustomProductServiceV2.0}BorrowerAnalyticsCycleSummary" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="OpenAccountsCurrentBalancePercentage" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BorrowerAnalyticsAccountSummary", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
    ...
    "openAccountsCurrentBalancePercentage"
})
public class BorrowerAnalyticsAccountSummary {
    ...
    @XmlElement(name = "OpenAccountsCurrentBalancePercentage")
    protected BigDecimal openAccountsCurrentBalancePercentage;
    ...
    /**
     * Gets the value of the openAccountsCurrentBalancePercentage property.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
     *     
     */
    public BigDecimal getOpenAccountsCurrentBalancePercentage() {
        return openAccountsCurrentBalancePercentage;
    }

    /**
     * Sets the value of the openAccountsCurrentBalancePercentage property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setOpenAccountsCurrentBalancePercentage(BigDecimal value) {
        this.openAccountsCurrentBalancePercentage = value;
    }
