...
/**
 * 
 * An entry loop which can repeat multiple times to record aggregated views of the spend information of this company based on category.
 *          
 * 
 * <p>Java class for SpendCategorySummaryType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SpendCategorySummaryType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="PurchaseCategoryText" type="{http://www.w3.org/2001/XMLSchema}string"/>
 ...
 *         &lt;element name="SpendAmountRangeSummary" type="{http://services.dnb.com/CustomProductServiceV2.0}SpendAmountRangeSummaryType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SpendCategorySummaryType", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
    ...
    "spendAmountRangeSummary"
})
public class SpendCategorySummaryType {

    @XmlElement(name = "PurchaseCategoryText", required = true)
    protected String purchaseCategoryText;
    ...
    @XmlElement(name = "SpendAmountRangeSummary")
    protected List<SpendAmountRangeSummaryType> spendAmountRangeSummary;

    /**
     * Gets the value of the purchaseCategoryText property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPurchaseCategoryText() {
        return purchaseCategoryText;
    }

    /**
     * Sets the value of the purchaseCategoryText property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPurchaseCategoryText(String value) {
        this.purchaseCategoryText = value;
    }
    ...
    /**
     * Gets the value of the spendAmountRangeSummary property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the spendAmountRangeSummary property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSpendAmountRangeSummary().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SpendAmountRangeSummaryType }
     * 
     * 
     */
    public List<SpendAmountRangeSummaryType> getSpendAmountRangeSummary() {
        if (spendAmountRangeSummary == null) {
            spendAmountRangeSummary = new ArrayList<SpendAmountRangeSummaryType>();
        }
        return this.spendAmountRangeSummary;
    }
