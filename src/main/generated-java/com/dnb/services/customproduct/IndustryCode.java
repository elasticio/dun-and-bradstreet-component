 ...
 *         &lt;element name="PrimaryIndustryCode" type="{http://services.dnb.com/CustomProductServiceV2.0}PrimaryIndustryCodeType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "IndustryCode", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
    "industryCode",
    "primaryIndustryCode"
})
public class IndustryCode {
    ...
    @XmlElement(name = "PrimaryIndustryCode")
    protected List<PrimaryIndustryCodeType> primaryIndustryCode;
    ...
    /**
     * Gets the value of the primaryIndustryCode property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the primaryIndustryCode property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrimaryIndustryCode().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PrimaryIndustryCodeType> getPrimaryIndustryCode() {
        if (primaryIndustryCode == null) {
            primaryIndustryCode = new ArrayList<PrimaryIndustryCodeType>();
        }
