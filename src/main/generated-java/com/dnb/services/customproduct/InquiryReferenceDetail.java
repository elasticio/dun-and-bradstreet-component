 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="CustomerBillingEndorsementText" type="{http://services.dnb.com/CustomProductServiceV2.0}CustomerReferenceText" minOccurs="0"/>
 *         &lt;element name="PrincipalReferenceText" type="{http://services.dnb.com/CustomProductServiceV2.0}PrincipalReferenceText" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "InquiryReferenceDetail", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
...
public class InquiryReferenceDetail {
    ...
    @XmlElement(name = "PrincipalReferenceText")
    protected List<PrincipalReferenceText> principalReferenceText;
    ...
    /**
     * Gets the value of the principalReferenceText property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the principalReferenceText property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrincipalReferenceText().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PrincipalReferenceText }
     * 
     * 
     */
    public List<PrincipalReferenceText> getPrincipalReferenceText() {
        if (principalReferenceText == null) {
            principalReferenceText = new ArrayList<PrincipalReferenceText>();
        }
        return this.principalReferenceText;
    }
