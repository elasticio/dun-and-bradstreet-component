 ...
 *         &lt;element name="PastDuePercentageCycleSummary" type="{http://services.dnb.com/CustomProductServiceV2.0}PastDuePercentageCycleSummary" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "OverallPaymentHistorySummary", namespace = "http://services.dnb.com/CustomProductServiceV2.0", propOrder = {
    "totalPaymentsCount",
