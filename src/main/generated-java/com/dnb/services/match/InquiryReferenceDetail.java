...
/**
 * 
 * Records data that allows the customer to specify information to be linked to the request in order to support subsequent requests.
 *          
 * 
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="CustomerBillingEndorsementText" type="{http://services.dnb.com/CompanyServiceV2.0}CustomerReferenceText" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "InquiryReferenceDetail", namespace = "http://services.dnb.com/CompanyServiceV2.0", propOrder = {
