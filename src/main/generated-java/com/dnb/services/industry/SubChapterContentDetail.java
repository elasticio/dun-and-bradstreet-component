 ...
 *       &lt;sequence>
 *         &lt;element name="TitleText" type="{http://services.dnb.com/IndustryProductServiceV2.0}StringBaseType256" minOccurs="0"/>
 *         &lt;element name="ContentText" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="KeyFactText" type="{http://services.dnb.com/IndustryProductServiceV2.0}StringBaseType256" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "SubChapterContentDetail", propOrder = {
    "titleText",
    "contentText",
    "keyFactText",
    "questionText",
