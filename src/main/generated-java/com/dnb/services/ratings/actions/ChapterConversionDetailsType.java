 ...
 *       &lt;sequence>
 *         &lt;element name="ConversionDate" type="{http://services.dnb.com/AssessmentProductServiceV2.0}DNBDateType" minOccurs="0"/>
 *         &lt;element name="ConversionChapterNumber" type="{http://services.dnb.com/AssessmentProductServiceV2.0}StringBaseType128" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ChapterConversionDetailsType", namespace = "http://services.dnb.com/AssessmentProductServiceV2.0", propOrder = {
    "conversionDate",
