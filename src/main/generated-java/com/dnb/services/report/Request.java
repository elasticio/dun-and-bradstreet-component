 ...
 *       &lt;sequence>
 *         &lt;element name="TransactionDetail" type="{http://services.dnb.com/ReportProductServiceV2.0}RequestTransactionDetail" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="ServiceVersionNumber" type="{http://services.dnb.com/ReportProductServiceV2.0}ServiceVersionNumber" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Request", namespace = "http://services.dnb.com/ReportProductServiceV2.0", propOrder = {
    "transactionDetail"
})
@XmlSeeAlso({
    OrderCompanyPublicDocumentRequest.class,
    OrderCountryReportRequest.class,
    OrderCompanyReportRequest.class
})
