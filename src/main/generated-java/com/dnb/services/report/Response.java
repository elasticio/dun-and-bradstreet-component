 ...
 *       &lt;sequence>
 *         &lt;element name="TransactionDetail" type="{http://services.dnb.com/ReportProductServiceV2.0}ResponseTransactionDetail"/>
 *         &lt;element name="TransactionResult" type="{http://services.dnb.com/ReportProductServiceV2.0}TransactionResult"/>
 *       &lt;/sequence>
 *       &lt;attribute name="ServiceVersionNumber" use="required" type="{http://services.dnb.com/ReportProductServiceV2.0}ServiceVersionNumber" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Response", namespace = "http://services.dnb.com/ReportProductServiceV2.0", propOrder = {
    "transactionDetail",
    "transactionResult"
})
@XmlSeeAlso({
    OrderCompanyReportResponse.class,
    OrderCountryReportResponse.class,
    OrderCompanyPublicDocumentResponse.class
})
