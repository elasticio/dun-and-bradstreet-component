 ...
 *         &lt;element name="TimeSinceFirstAccountOpenedPeriod" type="{http://services.dnb.com/SBRIProductServiceV2.0}DurationType" minOccurs="0"/>
 *         &lt;element name="TimeSinceLastChargeOffPeriod" type="{http://services.dnb.com/SBRIProductServiceV2.0}DurationType" minOccurs="0"/>
 *         &lt;element name="TimeSinceAccountLastOpenedPeriod" type="{http://services.dnb.com/SBRIProductServiceV2.0}DurationType" minOccurs="0"/>
 *         &lt;element name="OpenAccountsTotalExposureAmount" type="{http://services.dnb.com/SBRIProductServiceV2.0}AmountType" minOccurs="0"/>
 ...
 *         &lt;element name="InvoluntarilyClosedAccountsMaximumPeriod" type="{http://services.dnb.com/SBRIProductServiceV2.0}DurationType" minOccurs="0"/>
 *         &lt;element name="VoluntarilyClosedAccountsMaximumPeriod" type="{http://services.dnb.com/SBRIProductServiceV2.0}DurationType" minOccurs="0"/>
...
@XmlType(name = "BorrowerAnalyticsOverallSummary", namespace = "http://services.dnb.com/SBRIProductServiceV2.0", propOrder = {
    "openAccountsCount",
