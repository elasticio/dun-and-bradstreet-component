 ...
 *       &lt;sequence>
 *         &lt;element name="AccountTypeText" type="{http://services.dnb.com/SBRIProductServiceV2.0}DNBDecodedStringType"/>
...
@XmlType(name = "MiscellaneousDetails", namespace = "http://services.dnb.com/SBRIProductServiceV2.0", propOrder = {
    "accountTypeText",
    "lenderName",
    "lenderID",
    "paymentReportedDate",
