 ...
 *       &lt;sequence>
 *         &lt;element name="OrganizationName" type="{http://services.dnb.com/SBRIProductServiceV2.0}DNBStringType256"/>
...
@XmlType(name = "OrganizationNameBaseType", namespace = "http://services.dnb.com/SBRIProductServiceV2.0", propOrder = {
    "organizationName",
    "displaySequence"
})
@XmlSeeAlso({
