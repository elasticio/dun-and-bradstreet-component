 ...
 *       &lt;sequence>
 *         &lt;element name="ScoreUseCautionText" type="{http://services.dnb.com/SBRIProductServiceV2.0}DNBDecodedStringType" minOccurs="0"/>
 *         &lt;element name="ScoreReason" type="{http://services.dnb.com/SBRIProductServiceV2.0}ScoreReason" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "SBRIScore", namespace = "http://services.dnb.com/SBRIProductServiceV2.0", propOrder = {
    "scoreUseCautionText",
    "scoreReason",
    "scoreCardID",
