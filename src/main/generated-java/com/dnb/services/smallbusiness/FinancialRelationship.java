 ...
 *       &lt;sequence>
 *         &lt;element name="LoanAccountDetail" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountDetail" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="LeaseAccountDetail" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountDetail" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="LineOfCreditAccountDetail" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountDetail" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CreditCardAccountDetail" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountDetail" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="LoanAccountSummary" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountSummaryType" minOccurs="0"/>
 *         &lt;element name="LeaseAccountSummary" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountSummaryType" minOccurs="0"/>
 *         &lt;element name="LineOfCreditAccountSummary" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountSummaryType" minOccurs="0"/>
 *         &lt;element name="CreditCardAccountSummary" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountSummaryType" minOccurs="0"/>
 *         &lt;element name="LoanPayment" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountPayment" minOccurs="0"/>
 *         &lt;element name="LeasePayment" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountPayment" minOccurs="0"/>
 *         &lt;element name="LineOfCreditPayment" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountPayment" minOccurs="0"/>
 *         &lt;element name="CreditCardPayment" type="{http://services.dnb.com/SBRIProductServiceV2.0}AccountPayment" minOccurs="0"/>
 *         &lt;element name="OverallCurrentPaymentSummary" type="{http://services.dnb.com/SBRIProductServiceV2.0}OverallSummary" minOccurs="0"/>
 *         &lt;element name="OverallPaymentHistorySummary" type="{http://services.dnb.com/SBRIProductServiceV2.0}OverallPaymentHistorySummary" minOccurs="0"/>
 *         &lt;element name="GuaranteeDetails" type="{http://services.dnb.com/SBRIProductServiceV2.0}GuaranteeDetails" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="MiscellaneousDetails" type="{http://services.dnb.com/SBRIProductServiceV2.0}MiscellaneousDetails" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FinancialRelationship", namespace = "http://services.dnb.com/SBRIProductServiceV2.0", propOrder = {
    "loanAccountDetail",
    "leaseAccountDetail",
