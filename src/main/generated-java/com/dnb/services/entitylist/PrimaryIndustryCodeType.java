 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="IndustryCodeDescription" type="{http://services.dnb.com/EntityListServiceV2.0}IndustryCodeDescriptionType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="IndustryExplanationText" type="{http://services.dnb.com/EntityListServiceV2.0}StringBaseType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PrimaryIndustryCodeType", namespace = "http://services.dnb.com/EntityListServiceV2.0", propOrder = {
    "industryCode",
...
public class PrimaryIndustryCodeType {
    ...
    @XmlElement(name = "IndustryExplanationText")
    protected String industryExplanationText;
    ...
    /**
     * Gets the value of the industryExplanationText property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getIndustryExplanationText() {
        return industryExplanationText;
    }

    /**
     * Sets the value of the industryExplanationText property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIndustryExplanationText(String value) {
        this.industryExplanationText = value;
    }
