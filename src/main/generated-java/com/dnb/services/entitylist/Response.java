 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://services.dnb.com/EntityListServiceV2.0}Message">
 *       &lt;sequence>
 *         &lt;element name="TransactionDetail" type="{http://services.dnb.com/EntityListServiceV2.0}ResponseTransactionDetail"/>
 *         &lt;element name="TransactionResult" type="{http://services.dnb.com/EntityListServiceV2.0}TransactionResult"/>
 *       &lt;/sequence>
 *       &lt;attribute name="ServiceVersionNumber" use="required" type="{http://services.dnb.com/EntityListServiceV2.0}ServiceVersionNumber" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Response", namespace = "http://services.dnb.com/EntityListServiceV2.0", propOrder = {
    "transactionDetail",
    "transactionResult"
})
@XmlSeeAlso({
    FindContactResponse.class,
    FindCompetitorResponse.class,
    FindIndustryResponse.class,
    FindCompanyResponse.class
})
