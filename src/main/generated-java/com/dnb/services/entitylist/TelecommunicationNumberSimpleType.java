...
@XmlType(name = "TelecommunicationNumberSimpleType", namespace = "http://services.dnb.com/EntityListServiceV2.0", propOrder = {
...
public class TelecommunicationNumberSimpleType {
    ...
    protected Integer internationalDialingCode;
     ...
     *     
     */
    public Integer getInternationalDialingCode() {
     ...
     *     
     */
    public void setInternationalDialingCode(Integer value) {
