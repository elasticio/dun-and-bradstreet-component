 ...
 *       &lt;attribute name="CurrencyISOAlpha3Code" type="{http://services.dnb.com/EntityListServiceV2.0}CurrencyISOAlpha3Code" />
 *       &lt;attribute name="UnitOfSize" type="{http://services.dnb.com/EntityListServiceV2.0}UnitOfSizeEnumeration" />
 *       &lt;attribute name="ReliabilityText" type="{http://services.dnb.com/EntityListServiceV2.0}StringBaseType256" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "AmountType", namespace = "http://services.dnb.com/EntityListServiceV2.0", propOrder = {
    "value"
})
