 ...
 *       &lt;sequence>
 *         &lt;element name="TransactionDetail" type="{http://services.dnb.com/EntityListServiceV2.0}RequestTransactionDetail" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="ServiceVersionNumber" type="{http://services.dnb.com/EntityListServiceV2.0}ServiceVersionNumber" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Request", namespace = "http://services.dnb.com/EntityListServiceV2.0", propOrder = {
    "transactionDetail"
})
@XmlSeeAlso({
    FindCompetitorRequest.class,
    FindContactRequest.class,
    FindCompanyRequest.class,
    FindIndustryRequest.class
})
